...
public class TestEntity extends BaseEntity {
	...
	Texture2D tex = TextureLoader.loadTexture("res/entities/houseBlue/color.png", InterpolationType.NEAREST);
	...
	public TestEntity() {
		...
		mesh = WavefrontLoader.loadObject("res/entities/houseBlue/mesh.obj");
