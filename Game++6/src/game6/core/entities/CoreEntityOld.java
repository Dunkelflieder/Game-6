...
public abstract class CoreEntityOld extends BaseEntity<Vector3f> {
	...
	private Map<? extends CoreBuilding> map;
	 ...
	 */
	public abstract EntityGui<? extends CoreEntityOld> getGui();
	...
	public void setMap(Map<? extends CoreBuilding> map) {
		this.map = map;
	}
